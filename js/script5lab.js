    ...
    switch (currentStage) {
        case 1:
            if (previousChoice === 1) {
                ...
                document.getElementById('game-image').src ="../img/img2_w.png";
            } else {
                ...
                document.getElementById('game-image').src = '../img/img3_w.png';
            }
            break;
        case 2:
            if (previousChoice === 3) {
                ...
                document.getElementById('game-image').src = '../img/img4_w.png';
            } else {
                ...
                document.getElementById('game-image').src = '../img/img5_w.png';
            }
            break;
        case 3:
            if (previousChoice === 5) {
        ...
        case 4:
            if (previousChoice === 9) {
                ...
                document.getElementById('game-image').src = '../img/img8_w.png';
                ...
                document.getElementById('game-image').src = '../img/img6_w.png';
                ...
                document.getElementById('game-image').src = '../img/img7_w.png';
            }
            break;
        case 5:
            if (previousChoice === 10) {
                ...
                document.getElementById('game-image').src = '../img/img9_w.png';
            } else {
                ...
                document.getElementById('game-image').src = '../img/img10_w.png';
            }
            break;
    }
    currentStage++;
